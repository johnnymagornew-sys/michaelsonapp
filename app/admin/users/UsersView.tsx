              ...
              <div className="flex gap-2 mt-3">
                ...
                {whatsappUrl(user.phone) && (
                  <a
                    ...
                    className="flex items-center justify-center w-11 bg-[#1a3a25] border border-[#25a244]/30 rounded-xl hover:bg-[#1e4a2e] transition-colors shrink-0"
                    title="פתח ווצאפ"
                  >
                    <svg viewBox="0 0 24 24" className="w-5 h-5 fill-[#25D366]">
                      ...
                      <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.112 1.523 5.84L0 24l6.338-1.499A11.946 11.946 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.006-1.374l-.36-.214-3.724.88.936-3.63-.235-.374A9.818 9.818 0 1112 21.818z"/>
                    </svg>
                  </a>
                )}
                <button
